      ...
      >
        ...
        <div className="flex items-center justify-between gap-3">
          <Button
            ...
            className="inline-flex items-center justify-center px-5 py-2 text-xs font-medium uppercase tracking-[0.18em] shadow-depth-1 transition-shadow hover:shadow-depth-2"
          >
      ...
      <div className="grid items-start gap-6 lg:grid-cols-[minmax(0,1.1fr)_minmax(0,1.3fr)]">
        <div className="mood-glow rounded-[1.75rem] border border-[color:var(--color-border)] bg-[color:var(--color-surface)]/70 px-6 pb-6 pt-5 shadow-depth-2">
          ...
          <div className="flex flex-wrap gap-3 pt-3">
            ...
            <Button variant="ghost" className="whisper-ring shadow-depth-1 hover:shadow-depth-2">
              Share transmission
            </Button>
          </div>
        </div>
